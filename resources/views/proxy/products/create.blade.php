...
@section('content')
    ...
    {!! Form::open(['url' => route('proxy.products.store'), 'id' => 'productForm', 'enctype' => 'multipart/form-data',"onsubmit"=>"productGenerator.createOrUpdateProduct('create','".\App\Enum\MethodEnum::POST."');return false;"]) !!}
    @csrf
