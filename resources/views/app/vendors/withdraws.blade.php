                                ...
                                @if ($transaction->approved == 'pending')
                                    ...
                                    <span id="action_holder">
                                        <a class="btn btn-sm btn-success"
                                            onclick="productGenerator.manageVendorApproval(this,'{{ $route }}', '{{ $transaction->id }}','approved' );"
                                            data-bs-toggle="tooltip" title="{{ trans('general.approved') }}">
                                            <i class="fa fa-check"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger"
                                            onclick="productGenerator.manageVendorApproval(this,'{{ $route }}', '{{ $transaction->id }}', 'rejected' );"
                                            data-bs-toggle="tooltip" title="{{ trans('general.rejected') }}">
