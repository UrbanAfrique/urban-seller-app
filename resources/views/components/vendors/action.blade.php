...
@if (!empty($vendor->approved))
    <a class="btn p-0 mx-2"
        onclick="productGenerator.deleteVendor(this, '{{ route('app.vendors.destroy', [$vendor->id, 'shop' => \App\Services\SellerService::getSellerDomain(), 'timestamp' => time()]) }}');">
